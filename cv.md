...
I am hardworking, persistent and love to learn new things. I can work in a team and multitask.
I always open to new knowledge and ready to develop.
...
class Main {
  public static void main(String[] args) {
    ...
    System.out.print(multi.multiply(4.6, 7.2));
  }
}
```
